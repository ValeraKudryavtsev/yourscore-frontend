...
const Registration = () => {
    ...
    function checkUsername(username) {
        fetch(`https://yourscore-backend.onrender.com/user/check/${username}`)
            .then(resp => resp.text())
            .then(data => {
                if (data === "") {
    ...
    function registrationFun(e) {
        ...
        fetch("https://yourscore-backend.onrender.com/user/registration", {
            method: "POST",
            headers: {
    ...
    return (
        <div className="sign-in">
            <div className="sign-in__box">
                ...
                <form onSubmit={(passwordEnable === true && usernameEnable === true) ? registrationFun : registrationDummy} className="sign-in__form">
                    <input required className={usernameEnable ? "sign-in__input" : "sign-in__input sign-in__input-error"}
                           type="text"
                           name="username"
